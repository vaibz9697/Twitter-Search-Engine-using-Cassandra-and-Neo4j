...
query5 = "create table t_by_hashtag ( " \
        "location varchar," \
        "quote_count int," \
        "reply_count int," \
        "hashtag varchar," \
        ...
        "PRIMARY KEY ((hashtag),datetime,tid)) WITH CLUSTERING ORDER BY(datetime DESC);"
