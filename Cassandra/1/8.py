...
query8 = "create table t_for_delete ( " \
        "location varchar," \
        "quote_count int," \
        "reply_count int," \
        ...
        "PRIMARY KEY ((date_tweet),tid)) WITH CLUSTERING ORDER BY(tid DESC);"
